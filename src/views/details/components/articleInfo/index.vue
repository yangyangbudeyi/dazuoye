<template>
  <div
    class="articleInfo"
    :style="{ padding: isActive || catalogData.length ? ' 13px 10px 6px' : 0 }"
  >
    ...
    <div class="navigate" v-if="catalogData.length">
      <p class="tip">目录导航:</p>
      <li v-for="(item, index) in catalogData" :key="index"  @click="clickTitle(item?.text)">
