...
export const routes:RouteRecordRaw[] = [
    ...
    {path: "/tools/link", component: ToolsLink,meta:{title:"工具链接"}},
    {path: "/write/article", component: WriteArticle,meta:{title:"写文章",keepAlive:true}},
    {path: "/details/:artId",name:"details", component: Details,meta:{title:"文章详情",disAbledFooter:true}},
    {path: "/search", component: Search,meta:{title:"文章搜索",keepAlive:true}},
    {path: "/tags", component: Tags,meta:{title:"分类标签"}},
    {path: "/search/link", component: SearchLink,meta:{title:"链接搜索"}},
    {path: "/select/:userId", name:"select",component: Select,meta:{title:"用户信息",keepAlive:true}},
