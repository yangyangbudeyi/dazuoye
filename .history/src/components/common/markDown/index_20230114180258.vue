...
const options ={
  ...
  previewTheme:'vuepress',  //'default' | 'github' | 'vuepress' | 'arknights' |'mk-cute' | 'smart-blue' | 'cyanosis'
  preview:true,       //是否预览
  // previewOnly:false,    //是否只读
}
const theme:any = ref("light")
const showCodeRowNumber = ref(localStorage.getItem("line")=='true'?true:false)
