<template>
  <!-- 子级分类 -->
  <Loading :height="210" class="searchLoading" darkBg="#F2F3F5" lightBg="#F2F3F5" :key="Date.now()" :top="-165" v-if="!secondCate.length"/>
  <!-- <div class="loadings" element-loading-background="#F2F3F5"  element-loading-text="拼命加载中..." v-if="!secondCate.length" v-loading="true"></div> -->
