  ...
  <div class="box" >
    <div class="select-box">
      ...
      <div class="select-content">
        <button
          class="learn-more select-content-list changeHover"
...
.select-box {
  ...
  .select-content {
    ...
    .active {
      .circle {
        width: 100%;
        box-shadow:  0 0 10px var(--el-bg-color-articleItemBg);
        .icon {
          background: var(--el-bg-color-arrowCol);
...
.changeHover:hover .circle {
  width: 100%;
  box-shadow:  0 0 10px var(--el-bg-color-shadowCol);
}

.changeHover:hover .circle .icon.arrow {
  background: var(--el-bg-color-arrowCol);
  transform: translate(1rem, 0);
}
