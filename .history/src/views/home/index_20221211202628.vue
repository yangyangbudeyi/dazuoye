  ...
  <div class="home">
    <div class="left" >
      <div class="skeleton" v-if="!articleData.length">
        <el-skeleton v-for="item in 3" :key="item" :animated="true">
          <template #template>
            <div>
              <el-skeleton-item class="items"  style="width: 20%;" />
            </div>
            <div>
              <el-skeleton-item class="items"  style="width: 75%;" />
            </div>
            <div>
              <el-skeleton-item class="items"  style="width: 60%;" />
            </div>
            <div>
              <el-skeleton-item class="items"  style="width: 70%;" />
            </div>
          </template>
        </el-skeleton>
      </div>
