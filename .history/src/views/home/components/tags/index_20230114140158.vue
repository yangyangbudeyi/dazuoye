<template>
  ...
  <!-- <div :class="sticky?!homePage?'tags_article isSticky detailPage':'tags_article isSticky':'tags_article'"> -->
    <div class="top">
    ...
    <div class="item">
      ...
      <li v-else @click="navigateTags(item.name)" v-for="item in data" :key="item.tagId">{{item.name}} </li>
    </div>
  </div>
</div>
</template>
