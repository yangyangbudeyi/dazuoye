  ...
  <div class="artInfoForm">
    ...
    >
      ...
      <el-form-item label="内容详情" class="item"  prop="artIntroduce">
        <el-input clearable v-model.trim="ruleForm.artIntroduce"  placeholder="请填写内容详情(简单描述文章主题内容)" type="text" autocomplete="off" />
      </el-form-item>
...
//点击预览
const clickPreView = ()=>{
  if(!ruleForm.artContent) return ElMessage.warning("文章内容不能为空哦")
