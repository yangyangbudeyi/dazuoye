  ...
  <div class="profile">
    <div class="left">
      <div class="avatar">
        <div class="imgBox">
          <img :src="userImg" alt="" />
          <span class="gender">{{ gender=='1'?'💁‍♂️':'💁‍♀️' }}</span>
        </div>
        <div class="info">
          <span>{{ nickName }}</span>
      ...
      <div class="menu">
        ...
        <router-link to="/profile/suggestion" active-class="active">
          <el-icon><MessageBox /></el-icon>意见反馈</router-link
        >
        <router-link to="/profile/setting" active-class="active">
          <el-icon><Setting /></el-icon>个性设置</router-link
        >
      </div>
    </div>
    <div class="right">
