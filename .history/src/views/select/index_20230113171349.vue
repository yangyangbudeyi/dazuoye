<template>
  <div class="select" >
    <el-tabs v-model="activeName" disabled class="demo-tabs" @tab-click="handleClick">
      <el-tab-pane label="TA的基本信息"  name="info">
        <BaseInfo :data="userInfo"></BaseInfo>
      </el-tab-pane>
      <el-tab-pane label="TA的文章" name="article">
        <SelectArticle :userId="userId"></SelectArticle>
      </el-tab-pane>
      <el-tab-pane label="TA的收藏" name="collect">
        <SelectCollect  :userId="userId"></SelectCollect>
      </el-tab-pane>
      <el-tab-pane label="TA的点赞" name="like">
