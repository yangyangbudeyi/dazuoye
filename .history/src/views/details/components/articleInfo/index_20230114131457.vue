<template>
      <Loading :height="120"  style="margin-bottom:10px"  class="searchLoading" :key="Date.now()" :top="-200" v-if="!artTitle"/>
  <div class="articleInfo" v-else :style="{'padding': isActive || catalogData.length?'15px':0}">
